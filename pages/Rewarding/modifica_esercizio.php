	...
	if($row["tot"]==0) {
		...
		if(!isset($_SESSION["id_classe"])) {
			...
			if($row["tot"]<1) {
				...
				if(!isset($_GET["id_esercizio"]) || !isset($_GET["id_quest"])) {
					
					echo "<div class='alert alert-danger'>Errore: Nessun esercizio o quest selezionati <strong><a href='./quest_all.php'>INDIETRO</a></strong></div>";
				}
				else {
			...
			<div id="content-wrapper" class="d-flex flex-column">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<h1 class="h3 mb-4 text-gray-800">Modifica capitolo <?php echo $row["nome_capitolo"]; ?></strong></h1>
						...
						<div class="row" style="width:100%;margin:auto;">
								...
								<form action="update_capitolo.php" method="POST" id="form_capitolo" style="width:90%;">
									...
									<!-- Input con icona a sinistra -->
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  ...
										  <input type="text" class="form-control" name="nome_capitolo" id="nome_capitolo" value="<?php echo $row["nome_capitolo"]; ?>" placeholder="Nome del capitolo">
										  <input type="hidden" name="id_quest" value="<?php echo $id_quest; ?>" />
										  <input type="hidden" name="id_esercizio" value="<?php echo $id_esercizio; ?>" />
										</div>
									  </div>
									  <?php
									  $params2 = [["value"=>$id_quest],["value"=>$id_esercizio]];
										$query2="select progressivo from ct_esercizi_quest where fk_quest=? and fk_esercizio=? ";
										$rowp=eseguiQueryPrepareOne($query2,$params2);
									 ?>
									  <div class="mb-3" >
										<label for="progressivo" class="form-label">Progressivo</label>
										<div class="input-group" >
										  <span class="input-group-text"><i class="fas fa-bars"></i></span>
										  <input type="number" class="form-control" name="progressivo" id="progressivo" value="<?php echo $rowp["progressivo"]; ?>" placeholder="Progressivo">
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  ...
										  <select id="tipo_esercizio" disabled name="tipo_esercizio" class="form-select" style="width:90%;" >
												<?php
												$params2 = [];
												$query2="select * from ct_tipi_esercizio";
												$resultset2=eseguiQueryPrepareMany($query2,$params2);
												foreach($resultset2 as $rowm) {
													if($rowm["id_tipo_esercizio"]==$row["tipo_esercizio"])
														echo "<option value='$rowm[id_tipo_esercizio]' selected>$rowm[tipo]</option>";
													else 
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  ...
										  <select id="materia" name="materia" disabled class="form-select" style="width:90%;" onchange="cambia_materia();">
												<?php
												$params2 = [["value"=>$row["fk_argomento"]]];
												$query2="select * from ct_materie inner join ct_argomenti on fk_materia=id_materia and id_argomento=?";
												$rowmat=eseguiQueryPrepareOne($query2,$params2);
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  <span class="input-group-text"><i class="fas fa-list"></i></span>
										  <select id="argomento" disabled name="argomento" class="form-select" style="width:90%;">
												<?php
												$params2 = [["value"=>$row["fk_argomento"]]];
												$rowarg=eseguiQueryPrepareOne("select * from ct_argomenti where id_argomento=?",$params2);
												echo "<option value='$rowarg[id_argomento]' selected>$rowarg[nome_argomento]</option>";
												?>
										  </select>
										</div>
									  </div>
									 ...
									 <!-- Input con icona a sinistra -->
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  ...
										  <input type="number" class="form-control" id="xp_points" name="xp_points" value="<?php echo $row["punti_esperienza"]; ?>" placeholder="Punti esperienza">
										</div>
									  </div>
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  <textarea id="story" name="story" rows="30" cols="80" >
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  <span class="input-group-text"><i class="fas fa-bolt"></i></span>
										  <input type="number" class="form-control" value="<?php echo $row["num_domande"]; ?>" id="num_domande" name="num_domande" placeholder="Numeo domande quiz">
										</div>
									  </div>
									  ...
									  <div class="mb-3" >
										...
										<div class="input-group" >
										  <textarea id="testo_esercizio" name="testo_esercizio" rows="30" cols="80" >
